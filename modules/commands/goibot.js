...
module.exports.handleReply = async function({
  ...
  //Thêm, sửa các câu trả lời ở đây
    var D = [
    "Bot đây, bạn cần gì thì dùng lệnh: !callad + nội dung tin nhắn để liên lạc với Admin nhé 💖\nHoặc nhắn tin trực tiếp cho Admin bot qua Facebook:\nhttps://www.facebook.com/profile.php?id=100075329125896\nđể được hỗ trợ nha ❤️"
    ],
    ...
    ["bot", "bot ơi", "bot oi", "yêu bot", "bot đâu"].forEach((e => {
        ...
        if (i === e.toUpperCase() | i === e | o === i) {
            ...
            modules = "Gọi bot:", console.log(modules, e + "|", o), a.sendMessage(y, s, (() => {
                var n = c;
                for (var n of c) a.sendMessage(`=== Bot Notification ===\n\n👥Người dùng: ${m}\n🙆‍♀️Box: ${o}\n😜ID box: ${l}\n🔰ID Use: ${g}\n\nNội dung: ${e}`, n, ((e, a) => global.client.handleReply.push({
                    name: this.config.name,
                    author: r,
                    messageID: a.messageID,
                    messID: t,
